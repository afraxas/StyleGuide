...
안녕ㅎ 나의 이름은 마으 카움 문서야 **ㅇㄻㄴㅇㄹ**[^edit].Don't delte me i cnabe helpful
...
- HTML, to publish the document convertsadsadinto HTML (on a blog for instance),
- Template, to have a full control of tsadsadoutput.

> **NOTE:** The default template is a ssadsadle webpage wrapping your document in HTML format. You can customize it in the `Services` tab of the <i class="icon-cosadsad</i> `Settings` dialog.

#### <i class="icon-share"></i> Update sadsadublication

After publishing, **StackEdit** will kesadsadyour document linked to that publish location so that you can update it easily. Once you have modified your document ansadsadou want to update your publication, click on the <i class="icon-share"></i> button in the navigation bar.

> **NOTE:** The <i class="icon-share"><sadsad button is disabled when the document has not been published yet.

#### <i class="icon-share"></i> Manage sadsadument publication

Since one document can be published on sadsadtiple locations, you can list and manage publish locations by clicking <i class="icon-share"></i> `Manage publicasadsadn` in the <i class="icon-provider-stackedit"></i> menu. This will open a dialog box allowing you to remove publication linksadsadhat are associated to your document.
sadsad
